      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSectionDetails(
            "The co-ownership agreement ('Agreement',context,) is entered into between [Home Horizons Homes] and [Co-Owner(s)] for the joint ownership of the property located at [Property Address].",
            context,
          ),
          _buildSectionHeader(
